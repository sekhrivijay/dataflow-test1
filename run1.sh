...
--parameters "inputSubscription=projects/sekhrivijayrcs1/subscriptions/testsub,outputTableSpec=sekhrivijayrcs1:testdataset.testtable,outputDeadletterTable=sekhrivijayrcs1:testdataset.deadtable1"
